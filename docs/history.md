...
- Fixed the bug where using gold pills would cause an error.

### _v0.111.6_ - December 6th, 2023

- Fixed the bug in seeded races where using a horse Bad Trip pill at 2 hearts would count as fatal damage. (Thanks MonoKromu)

### _v0.111.5_ - November 29th, 2023

- Fixed the bug where D6 was not removed from pools while playing as Jacob & Esau. (Thanks Gamonymous)
...
### _v0.110.1_ - October 18th, 2023

- All shoot inputs will now be released for two frames when the Checkpoint spawns if you have IBS.

### _v0.110.0_ - October 18th, 2023

- Mines and Ashpit now have flipped rooms. (The rooms with the bugged Bomb Grimaces have been manually modified.)
- Mausoleum now has flipped rooms.

### _v0.109.3_ - October 13th, 2023

- Fixed the bug where Maggy's Faith would erroneously give you two eternal hearts if you had Dream Catcher. (Thanks Gamonymous)
- Fixed the bug where Dream Catcher would give a full soul heart instead of a half soul heart on unseeded runs.

### _v0.109.2_ - October 9th, 2023

- Fixed the bug where Lost Soul would override the free devil deal mechanic. (Thanks Monkeypot)

### _v0.109.1_ - October 3rd, 2023

- Fixed the bug where a run-time error could occur from the "Invisible Pickup" custom entity under certain conditions. (Thanks Gamonymous)
- Fixed the bug where Rotgut was in the Boss Rush. (Thanks 91)

### _v0.109.0_ - October 2nd, 2023
...
- Fixed the bug where using a reverse Moon card could cause a softlock under certain conditions. (Thanks Fallenfor)

### _v0.107.4_ - September 20th, 2023
...
- Fixed the bug where the Perfection trinket would spawn too early under certain circumstances. (Thanks Gamonymous)
- Fixed the bug where some UI elements would be drawn on the "no HUD" seed.
...
- Fixed the bug where Genesis rooms were not working properly. (Thanks Fallenfor)

### _v0.105.0_ - September 12th, 2023

- The frame delay for autofire and Spirit Sword / Chocolate Milk has been reduced from 5 frames to 4 frames.

### _v0.104.8_ - September 12th, 2023

- Fixed the bug where Damocles would not work properly with More Options in some situations. (Thanks mgln)

### _v0.104.7_ - September 11th, 2023

- Fixed the bug where the custom Mom's Hands animation would apply to friendly NPCs.

### _v0.104.4_ - September 11th, 2023

- Fixed the bug where pressing certain shoot buttons would cause Chocolate Milk to incorrectly fire under certain circumstances. (Thanks Toooschi)

### _v0.104.3_ - September 11th, 2023

- Fixed the bug where Damocles could cause items to spawn on top of spikes under certain conditions. (Thanks mgln)

### _v0.104.2_ - September 10th, 2023
...
- In seeded races, Tech X + Samson is now an anti-synergy.
- Fixed the bug where using the Babies Mod would cause an incorrect error message.
- Fixed the bug in season 2 where Empty Vessel would not grant flight with Revelation. (Thanks sisuka)

### _v0.102.13_ - June 5th, 2023
...
- Fixed the bug where killing It Lives could softlock you under certain circumstances. (Thanks Fallenfor)
...
- Fixed the bug where using a reverse Temperance card would cause errors. (Thanks mgln)

### _v0.102.9_ - April 24th, 2023
...
- In seeded races, Modeling Clay is now removed from pools. (Thanks Moucheron Quipet)

### _v0.102.6_ - April 7th, 2023

- Mom's Hands and Mom's Dead Hands will no longer have status effects while off-screen. (Thanks Gamonymous)

### _v0.102.4_ - April 5th, 2023

- Fixed the bug where silhouettes from the Flip would be shown in an incorrect position under certain circumstances. (Thanks Fallenfor)

### _v0.102.2_ - April 3rd, 2023

- Fixed the bug in season 4 where Dark Judas would revive with Book of Belial under certain circumstances. (Thanks Gamonymous)
- Fixed the bug with seeded death where some lasers were getting incorrectly removed. (Thanks Fallenfor)

### _v0.102.1_ - April 1st, 2023

- Fixed the bug where 13 Luck and 15 Luck would not work properly with Eden. (Thanks AshDown)

### _v0.102.0_ - March 29th, 2023

- The appear animation of Blastocyst is now skipped.

### _v0.101.11_ - March 28th, 2023

- Fixed the bug where heaven doors would not spawn under certain conditions. (Thanks Cyber_1)

### _v0.101.9_ - March 28th, 2023

- Fixed the bug where heaven doors could spawn in situations that they were not supposed to under certain conditions. (Thanks mgln)
- Fixed the bug where killing Clog could cause a softlock under certain conditions. (Thanks mgln)

### _v0.101.8_ - March 28th, 2023

- Fixed the bug where the vanilla crawlspace behavior would not be overridden under certain circumstances. (Thanks mgln)
...
- The Lead Pencil charge bar will no longer show if you have Spirit Sword. (Thanks Gamonymous)
- Fixed the bug where speedrun variables were not reset when playing a non-speedrun. (Thanks Monkeypot)

### _v0.101.4_ - March 22nd, 2023

- Fixed the bug where the photos could disappear when re-entering the Mom room. (Thanks Hazu)

### _v0.101.3_ - March 21st, 2023

- Fixed the bug in season 4 where Glowing Hour Glass would not work properly with stored items. (Thanks Fallenfor)
...
- Black Candle is now only removed in seeded races.

### _v0.99.1_ - March 12th, 2023

- Fixed the bug where using a Crooked Penny could recharge the D6 under certain conditions. (Thanks Fallenfor)
- Fixed the bug where resetting the game could cause an error under certain conditions. (Thanks Fallenfor)
...
- Lachryphagy tears will now be faded so that they are not confused for enemy tears.

### _v0.97.6_ - March 6th, 2023

- Fixed the bug where Horse Pills would not display properly on the pill UI. (Thanks Monkeypot)
...
- Fixed the bug where Gabriel could incorrectly drop key pieces in certain situations. (Thanks sisuka)

### _v0.97.3_ - March 5th, 2023
...
- Fixed the bug where Goat Head or Eucharist would incorrectly open the Devil Room or Angel Room door under certain circumstances. (Thanks sisuka)

### _v0.97.1_ - March 4th, 2023

- Fixed the bug where you could not roll key pieces. (Thanks ArutheArrow)

### _v0.97.0_ - March 3rd, 2023
...
- Fixed the bug where PHD, Virgo, and False PHD would make the pill display work incorrectly. (Thanks Monkeypot)

### _v0.95.2_ - February 23rd, 2023

- Fixed the bug where the the top door in the starting room would be incorrectly unlocked. (Thanks KiraKeepKool)
- Fixed the bug where dark angels could drop key pieces. (Thanks KiraKeepKool)

### _v0.95.1_ - February 23rd, 2023

- Fixed the bug where the mod would crash under certain circumstances. (Thanks AshDown)
...
- The projectiles and lasers from friendly enemies will now be faded.
