...
export const BOSS_PNG_MAP: ReadonlyMap<EntityType, readonly string[]> = new Map(
  [
    // 19
    [
      EntityType.LARRY_JR,
    ...
    // 409
    [EntityType.RAG_MEGA, ["portrait_ragmega.png"]],

    // 410
    [EntityType.SISTERS_VIS, ["portrait_sistersvis.png"]],

    // 411
    [EntityType.BIG_HORN, ["portrait_bighorn.png"]],

    // 412
    [EntityType.DELIRIUM, ["portrait_delirium.png"]],

    // 413
    [EntityType.MATRIARCH, ["portrait_matriarch.png"]],
    ...
    // 912
    [EntityType.MOTHER, ["portrait_mother.png"]],

    // 913
    // The "portrait_913.0_maidinthemist.png" file is unused.
    [EntityType.MIN_MIN, ["portrait_minmin.png"]],

    // 914
    [EntityType.CLOG, ["portrait_clog.png"]],

    // 915
    [EntityType.SINGE, ["portrait_singe.png"]],

    // 916
    [EntityType.BUMBINO, ["portrait_bumbino.png"]],

    // 917
    [EntityType.COLOSTOMIA, ["portrait_colostomia.png"]],

    // 918
    [EntityType.TURDLET, ["portrait_turdlet.png"]],

    // 919
    [EntityType.RAGLICH, ["portrait_raglich.png"]],

    // 920
    [EntityType.HORNY_BOYS, ["portrait_hornyboys.png"]],

    // 921
    [EntityType.CLUTCH, ["portrait_clutch.png"]],

    // 950
    [EntityType.DOGMA, ["portrait_dogma.png"]],
  ],
);
