...
// Cookie text by immediately showing normal streak text after a Fortune Cookie use. Since removing
// the vanilla streak text is mandatory, this feature is also mandatory.
