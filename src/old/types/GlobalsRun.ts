...
export default class GlobalsRun {
  ...
  forgetMeNow = false;
  consoleOpened = false; // If set, fast-resetting is disabled
  ...
  fastClear = {
    roomClearAwardRNG: 0,
    roomClearAwardRNG2: 0, // Used for Devil Rooms and Angel Rooms
    aliveEnemies: new Map<int, boolean>(), // Keys are NPC pointer hashes, values are isBoss
    aliveEnemiesCount: 0,
    aliveBossesCount: 0,
    buttonsAllPushed: false,
    roomInitializing: false, // Set to true in the PostNewRoom callback
    delayFrame: 0,
  };
