...
local ____enums = require("types.enums")
local CollectibleTypeCustom = ____enums.CollectibleTypeCustom
local startsWithD6 = require("features.optional.major.startWithD6")
local ____constants = require("features.race.constants")
...
local CHARACTERS_WITH_AN_ACTIVE_ITEM, unseeded, unseededRankedSolo, seeded, diversity, shouldGetSchoolbagInDiversity
...
function diversity(self, player)
    ...
    if shouldGetSchoolbagInDiversity(nil, player) then
...
function shouldGetSchoolbagInDiversity(self, player)
    local character = player:GetPlayerType()
    return (((__TS__ArrayIncludes(CHARACTERS_WITH_AN_ACTIVE_ITEM, character) or startsWithD6:shouldGetActiveD6(player)) and (character ~= PlayerType.PLAYER_EDEN)) and (character ~= PlayerType.PLAYER_EDEN_B)) and (character ~= PlayerType.PLAYER_ESAU)
end
CHARACTERS_WITH_AN_ACTIVE_ITEM = {PlayerType.PLAYER_ISAAC, PlayerType.PLAYER_MAGDALENA, PlayerType.PLAYER_JUDAS, PlayerType.PLAYER_XXX, PlayerType.PLAYER_EVE, PlayerType.PLAYER_EDEN, PlayerType.PLAYER_THELOST, PlayerType.PLAYER_LILITH, PlayerType.PLAYER_KEEPER, PlayerType.PLAYER_APOLLYON, PlayerType.PLAYER_JACOB, PlayerType.PLAYER_EDEN_B}
